...
<body>
	...
	<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="CustomerUpdate.jsp">update Customer</a>
				    <a class="dropdown-item" href="CustomerGetAll.jsp">Show All Customer</a>
				    <a class="dropdown-item" href="CustomerDelete.jsp">Delete Customer</a>
				    <a class="dropdown-item" href="CustomerGetById.jsp">Find by Id</a>
				    <a class="dropdown-item" href="CustomerCheckIn.jsp">Customer check In</a>
				    <a class="dropdown-item" href="CustomerCheckOut.jsp">Customer check Out</a>
				    </li>
			...
			<!--Approve  -->
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="AdminApproveLandLord.jsp">Landlord Approve</a>
					<a class="dropdown-item" href="AdminReadAllApprovedLandLord.jsp">All Approved Landlord</a>
					<a class="dropdown-item" href="AdminReadAllUnapprovedLandLord.jsp">All Unapproved Approve</a>
				    
				    <a class="dropdown-item" href="LandLordDAddHotelById.jsp">Landlord Add By Hotel Id</a>
				    </li>
				...
				<li class="nav-item dropdown"><a
				    ...
				    <a class="dropdown-item" href="LandLordGetAll.jsp">Show All Landlord</a>
				    <a class="dropdown-item" href="LandLordDelete.jsp">Delet Landlord</a>
				    <a class="dropdown-item" href="LandLordGetById.jsp">Find by Id</a>
				    </li>
				<!-- Room Cruds -->
	...
	<div class="card-deck">
		<div class="card">
			...
			<div class="card-footer">
				<a class="btn btn-primary" href="newhome2.jsp" role="button">Explore Rooms
					</a>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-footer">
				<a class="btn btn-primary" href="newhome2.jsp" role="button">Explore Rooms</a>
			</div>
		</div>
		<div class="card">
