			...
			<div class="col-md-8 p-3 mt-5">
				<div class="modal-dialog">
					<div class="modal-content">
						<form class="form-horizontal" action="loginservaletadmin" method="post">

							<div class="modal-header">
								<h5 class="modal-title d-flex align-items-center">
									<i class="bi bi-person-circle fs-3 me-2">Admin Login</i>
								</h5>
							...
							<div class="modal-body">
								...
								<div
									...
									<button type="submit" id="submit" class="btn btn-dark shadow-none">LOGIN</button>
